...
class ViewControllerOne : UIViewController,SJPushDataVCProtocol {
    ...
    override func viewDidLoad() {
        ...
        button.addTarget(self, action:#selector(ViewControllerOne.buttonClick), for: UIControlEvents.touchUpInside)
